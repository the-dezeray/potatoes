...
export const courseEnrollment = (name, courseName, price) =>
  baseTemplate(
    "#fbd35a",
    "Course Enrollment",
    `
    <p style="${boldText}">Hi ${name},</p>
    <p style="${bodyText}">
      You've successfully enrolled in <strong>${courseName}</strong> with the BIUST Innovation Club.
    </p>
      ...
      <tr>
        <td style="background:#fffbeb;border:2px solid #1c1c1c;box-shadow:3px 3px 0 #1c1c1c;padding:16px 20px;">
          ...
          <p style="margin:0;font-size:14px;color:#374151;line-height:1.6;">
            ...
            <strong>Price:</strong> ${price === 0 ? "FREE (Member)" : "P " + price + ".00"}<br/>
            <strong>Certificate:</strong> Included upon completion
          </p>
        </td>
      </tr>
    </table>
    ...
    <p style="${bodyText}">
      We'll send you more details about the course schedule and materials soon. 
